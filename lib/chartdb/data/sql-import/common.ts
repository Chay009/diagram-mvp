...
import { generateDiagramId, generateId } from '@/lib/chartdb/utils';
import type { DBTable } from '@/lib/chartdb/domain/db-table';
import type { Cardinality, DBRelationship } from '@/lib/chartdb/domain/db-relationship';
import type { DBField } from '@/lib/chartdb/domain/db-field';
import type { DBIndex } from '@/lib/chartdb/domain/db-index';
import type { DataType } from '@/lib/chartdb/data/data-types/data-types';
import { genericDataTypes } from '@/lib/chartdb/data/data-types/generic-data-types';
import { defaultTableColor } from '@/lib/chartdb/colors';
import { DatabaseType } from '@/lib/chartdb/domain/database-type';
import type { DBCustomType } from '@/lib/chartdb/domain/db-custom-type';
import { DBCustomTypeKind } from '@/lib/chartdb/domain/db-custom-type';
import { supportsCustomTypes } from '@/lib/chartdb/domain/database-capabilities';
